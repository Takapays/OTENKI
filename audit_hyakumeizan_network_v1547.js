...
vm.runInContext(s+`\nglobalThis.__X={JAPAN_100_MOUNTAINS,representativeCourseOptions,representativeCourseExpandedPointDefs,directCourseTimeInfoByNames,courseTimeInfo,normalizeCourseTimePointName,canonicalCourseTimeEndpointName,MAJOR_TRAIL_NETWORKS_V1547,GENERATED_ROUTE_EXCLUSIONS_V1545};`,sandbox,{timeout:30000});
const X=sandbox.__X;
...
for(const [area,net] of Object.entries(X.MAJOR_TRAIL_NETWORKS_V1547||{})){
...
const summary={
  ...
  explicitAreaNetworks:Object.keys(X.MAJOR_TRAIL_NETWORKS_V1547||{}).length
};
...
fs.writeFileSync('HYAKUMEIZAN_NETWORK_CT_AUDIT_V1547.json',JSON.stringify(payload,null,2));
const lines=[
 'TRATEN V1.5.47 HYAKUMEIZAN CT NETWORK AUDIT','',
...
fs.writeFileSync('HYAKUMEIZAN_NETWORK_CT_AUDIT_V1547.txt',lines.join('\n')+'\n');
