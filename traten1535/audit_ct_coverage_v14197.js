...
const OUT_TXT=path.join(ROOT,'CT_COVERAGE_AUDIT_V14197.txt');
const OUT_CSV=path.join(ROOT,'CT_MISSING_SEGMENTS_V14197.csv');
const OUT_EST=path.join(ROOT,'CT_ESTIMATED_SEGMENTS_V14197.csv');
