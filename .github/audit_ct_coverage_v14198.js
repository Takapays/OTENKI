...
const OUT_TXT=path.join(ROOT,'CT_COVERAGE_AUDIT_V14198.txt');
const OUT_CSV=path.join(ROOT,'CT_MISSING_SEGMENTS_V14198.csv');
const OUT_EST=path.join(ROOT,'CT_ESTIMATED_SEGMENTS_V14198.csv');
