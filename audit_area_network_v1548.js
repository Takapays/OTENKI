...
vm.runInContext(s+`\nglobalThis.__X={MAJOR_TRAIL_NETWORKS_V1548,directCourseTimeInfoByNames,courseTimeInfo,normalizeCourseTimePointName,canonicalCourseTimeEndpointName};`,sandbox,{timeout:30000});
const X=sandbox.__X;
