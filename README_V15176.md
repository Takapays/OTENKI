...
- Version and cache-busters: 1.5.176


## V1.5.176
- Simplified the four resource navigation buttons.
- Desktop: 4-column compact navigation; narrow desktop/tablet: stable 2x2 layout; mobile: stable 2x2 layout.
- Removed decorative card styling/subtitles from these buttons to prevent narrow-width overflow.
